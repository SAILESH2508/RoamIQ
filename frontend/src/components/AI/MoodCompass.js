import React, { useState } from 'react'; // Updated for orange colors
...
const moods = [
    { id: 'excited', label: 'Excited', icon: <FaBolt />, color: '#ff7a00', energy: 'high' },   /* Primary Orange */
    { id: 'happy', label: 'Happy', icon: <FaSmile />, color: '#ff9500', energy: 'medium' },  /* Lighter Orange */
    { id: 'neutral', label: 'Chill', icon: <FaMeh />, color: '#ffa733', energy: 'medium' },   /* Light Orange */
    { id: 'stressed', label: 'Stressed', icon: <FaFrown />, color: '#ff8c33', energy: 'low' }, /* Medium Orange */
    { id: 'tired', label: 'Tired', icon: <FaMoon />, color: '#ffcc99', energy: 'low' },        /* Light Orange */
];
                    ...
                    {isLoading ? (
                        ...
                        >
                            ...
                            <div className="text-center mt-4">
                                <Button variant="link" className="text-primary fw-bold p-0" onClick={() => setRecommendations([])}>
                                    Reset Compass
                                </Button>
                            </div>
                        </motion.div>
