...
async def get_destination_insights(user_id: int, destination: str) -> Dict[str, Any]:
    """Retrieve weather, scams, hidden gems and safety tips for a destination."""
    try:
        from backend.services.ai_service import ai_service
        result = await ai_service.get_destination_insights(destination)
...
AVAILABLE_TOOLS = {
    ...
    "get_destination_insights": get_destination_insights
}
...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": "Get specialized travel intelligence: hidden gems, weather vibe, and safety scams for a city.",
        "parameters": {
            "type": "object",
            "properties": {
                "destination": {"type": "string", "description": "The city or country to search for"}
            },
